        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 text-right">
                    ...
                    <div class="bg-gray-50 shadow-2xl p-8">
                        ...
                        >
                            ...
                            >
                                ...
                                <option v-for="color in availableColors" :value="color" :key="color.id">
                                    {{ color }}
                                </option>
                            </select>
                            ...
                            >
                                ...
                                <option v-for="icon in availableIcons" :value="icon" :key="icon.id">
                                    {{ icon }}
                                </option>
                            </select>
                ...
                <table v-if="skills.length > 0" class="w-full text-left">
                    ...
                    <tbody v-for="(skill, index) in skills" :key="skill.id">
                        ...
                        >
                            ...
                            <td class="px-6 py-4">
                                <p class="mr-5 py-3 px-5" :class="skill.color">{{ skill.color }}</p>
                            </td>
                            <td class="px-6 py-4" :class="skill.color">
                                <component
                ...
                <jet-confirmation-modal :show="confirmingUserDeletion" @close="confirmingUserDeletion = false">
                    ...
                    <template #content>
                        Are you sure you want to delete permanently this skill? 
                    </template>
